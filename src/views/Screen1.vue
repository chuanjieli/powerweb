...
export default {
  ...
  methods: {
    cutMap() {
      ...
      if (this.site === 'world') {
        this.$router.replace({ path: '/wafscreen/china' })
      } else {
        this.$router.replace({ path: '/wafscreen/world' })
      }
      this.reload()
    },
    block(e) {
...
.body {
  background: url('../assets/img/screen/back.png');
...
.header {
  ...
  margin: 0 auto;
  height: 5rem /* 80px */;
  background: url('../assets/img/screen/bottom_03.png') no-repeat center bottom;
  text-align: center;
  color: #0cbdfb;
...
.header > .logo {
  ...
  height: 5rem /* 80px */;
  background: url('../assets/img/screen/logo_03.png') no-repeat center center;
}
...
.header > .logo1 {
  ...
  width: 2.5rem /* 40px */;
  height: 2.5rem /* 40px */;
  /* background: url('../assets/img/screen/map.png'); */
...
.gradient {
  ...
  background: url('../assets/img/screen/gradient_03.png') no-repeat;
  background-size: cover;
}
...
.back1 {
  ...
  height: 2.5rem /* 40px */;
  margin: 13px auto;
  background: url('../assets/img/screen/back1_03.png');
...
.title {
  ...
  height: 2.5rem /* 40px */;
  margin: 10px auto;
  background: url('../assets/img/screen/fly.png');
  background-size: 100% 100%;
  line-height: 2.5rem /* 40px */;
  text-align: left;
}
...
.littleLogo {
  ...
  width: 1.75rem /* 28px */;
  height: 1.5rem /* 24px */;
  background: url('../assets/img/screen/title.png');
...
.arrow {
  ...
  /* background: url('../assets/img/screen/arrow1.png') no-repeat center center; */
  cursor: pointer;
}
